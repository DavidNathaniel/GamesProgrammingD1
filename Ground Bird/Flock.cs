...
public class Flock : MonoBehaviour {
        ...
        if (FlockManager.FM == null)
    {
        ...
        return;  // Exit the method early to avoid accessing a null reference
    }
    ...
    void Update() {
        ...
        Bounds b = new Bounds(FlockManager.FM.transform.position, FlockManager.FM.airLimits * 2.0f);
